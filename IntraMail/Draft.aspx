<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Draft.aspx.cs" Inherits="IntraMail.Draft" %>
                        ...
                        <td class="auto-style4">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:GridView ID="gridDispDraftMail" runat="server" CssClass="gridView" AutoGenerateColumns="False" ShowHeader="false" GridLines="None" Width="1000px">
                                             ...
                                             <Columns>
                                                ...
                                                <asp:TemplateField AccessibleHeaderText="Subject">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink runat="server" CssClass="inbox" NavigateUrl='<%# string.Format("~/DispDraft.aspx?Sub={0}&DraftId={1}",
                                                         HttpUtility.UrlEncode(Eval("Sub").ToString()), 
                                                          HttpUtility.UrlEncode(Eval("DraftId").ToString())) %>'
                                                            Text='<%# Eval("Sub") %>' />
                                            ...
                                            <%-- delete mails--%>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                    <asp:HyperLink runat="server" NavigateUrl='<%# Eval("DraftId","Draft.aspx?DraftId={0}")%>' Text="Delete" ForeColor="Black"></asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
