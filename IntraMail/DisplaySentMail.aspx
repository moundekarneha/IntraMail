<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisplaySentMail.aspx.cs" Inherits="IntraMail.DisplaySentMail" %>
       ...
       <div>
           <h1>
            ...
            <table class="auto-style5">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <table>
                                            <tr>
                                                <td style="font-weight: bold">Mail To:<br />
                                                </td>
                                                <td><%# Eval("MailTo")%><br />
                                                </td>
                ...
                <tr>
                    <td class="auto-style6">
                        <asp:HyperLink ID="HyperLink2" runat="server" Text="Reply" CssClass="inbox" NavigateUrl="~/ReplySentMail.aspx"></asp:HyperLink>
                    </td>
                </tr>
            </table>
        </div>
